...
5. CATEGORY SELECTION
   ...
   - If content is unclear, not in expected language, or only contact details: choose "{{ no_category_name }}"

6. JUSTIFICATION
   - 1-2 concise sentences: WHY this category; cite key text evidence (quote short phrase/words).
   - If categorized as "{{ no_category_name }}", state the reason (staff reply, unclear, off-topic, etc.)
