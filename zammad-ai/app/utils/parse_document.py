...
def parse_document(data: Any, attachment: ArticleAttachment, url: str | None) -> str:
...
def send_to_remote_kreuzberg(data: Any, url: str, attachment: ArticleAttachment) -> str:
    ...
    body, content_type = _build_multipart_body(
        ...
        {"files": (attachment.filename, document_bytes, "application/octet-stream")},
    )
...
def local_kreuzberg_processing(data: Any, attachment: ArticleAttachment) -> str:
